...
public class EntryTableModel implements TableModel, DictionaryListener {
	...
	public String getColumnName(int col) {
		switch (col) {
		case 0: return DictionaryMainWindow.getInstance().getLocalisedString("wordColumnName");
		case 1: return DictionaryMainWindow.getInstance().getLocalisedString("definitionColumnName");
		case 2: return DictionaryMainWindow.getInstance().getLocalisedString("categoryColumnName");
		case 3: return DictionaryMainWindow.getInstance().getLocalisedString("notesColumnName");
		default:
			return null;
		}
	}
	...
	public Object getValueAt(int row, int col) {
		...
		try {
			...
			return DictionaryMainWindow.getInstance().getLocalisedString("error") + " " + ex;
		}
		switch(col) {
		case 0:
